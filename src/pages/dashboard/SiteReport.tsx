...
export default function SiteReport() {
  ...
  const fetchData = async () => {
    ...
    setIsloading(false);
    await manageReport.getReportByDate(dateFormat, user?.siteid).then((rs) => {
      if (rs.status == 200) {
        ...
        <Container maxWidth={themeStretch ? false : 'lg'}>
          <Stack spacing={3} sx={{ mt: 5, mb: 5 }} maxWidth="98%">
            ...
            <Grid container justifyContent="space-between" spacing={2}>
              ...
              {siteReport?.numberOfOrder == null && siteReport?.numberOfGroup == null ? (
                <></>
              ) : (
                <Grid item xs={6} md={6}>
                  <InvoiceToolbar
          ...
          {siteReport?.numberOfOrder == null && siteReport?.numberOfGroup == null ? (
            <Stack mt={3} ml={2}>
              <Card sx={{ height: '700px' }}>
                <Typography pl={3} pt={3} sx={{ color: 'black' }}>
                  {translate('model.report.label.emptyNoti')}!
                </Typography>
              </Card>
            </Stack>
          ) : (
            ...
            Environmental information
                      ...
                      >
                        <TableRow>
                          ...
                          <TableCell align="left">
                            {translate('model.report.field.amount')}
                          </TableCell>
                ...
                <Grid item xs={6} md={6}>
                  <Stack maxWidth="67%">
                    ...
                    <RowStyle>
                      ...
                      <Typography variant="body2">{siteReport?.numberOfPartner}</Typography>
                    </RowStyle>
                  </Stack>
                </Grid>
              </Grid>
              ...
              <TableContainer sx={{ minWidth: 400 }}>
                <Table>
                  ...
                  <TableBody>
                    {/* {currentReport?.cellSurveys.map((cellSurvey: CellSurvey, index: number) => ( */}
                  ...
                  <Table>
                    ...
                    >
                      <TableRow>
                        <TableCell width={200}>
                          {' '}
                          {translate('model.report.field.orderId')}
                        </TableCell>
                        ...
                        <TableCell align="left">
                          {' '}
                          {translate('model.report.field.status')}
                        </TableCell>
                      </TableRow>
                    </TableHead>

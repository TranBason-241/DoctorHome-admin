...
type PatientMoreMenuProps = {
  onDelete: VoidFunction;
  patientID: string;
};

export default function PatientMoreMenu({ onDelete, patientID }: PatientMoreMenuProps) {
    ...
    <>
      ...
      >
        ...
        <MenuItem
          ...
          to={`${PATH_DASHBOARD.patient.root}/${paramCase(patientID)}/edit`}
